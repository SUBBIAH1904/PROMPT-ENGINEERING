...
| **Learning** | Often Supervised Learning | Mostly Self-Supervised Learning |
| **Example**  | Spam Detection Systems    | ChatGPT-like Systems            |
...
| --------------------------- | ------------------------------------------------------------ | ------------------------------------------------- | ---------------------------------------------- |
| **Healthcare**              | Drug discovery, medical imaging, report generation           | Variational Autoencoders (VAEs), Diffusion Models | AI-generated molecules, enhanced MRI/CT scans  |
| **Finance & Banking**       | Fraud detection, risk analysis, automated reporting          | Transformers                                      | Fraud prediction systems, financial summaries  |
| **Education**               | Personalized learning, tutoring, content creation            | GPT Models                                        | AI tutors, automated quizzes, notes generation |
...
| **Software & IT**           | Code generation, debugging, documentation                    | GPT Models                                        | Code assistants, auto-generated documentation  |
| **Marketing & Advertising** | Ad copy generation, campaign personalization                 | LLMs, Transformers                                | Targeted ads, social media content             |
| **Manufacturing**           | Product design, simulation, quality control                  | Generative Design Models                          | Prototype design, defect d                     |
